  ...
  return (
    <>
      ...
      <section className="policy">
        <h1>Trip Match — Privacy & Data Use Policy</h1>
        ...
        <div className="card">
          ...
          <ul>
            <li>
              We collect only what we need to run Trip Match and improve your
              experience.
            </li>
            ...
            <li>
              Contact us:{" "}
              <a href="mailto:support@tripmatch.com">support@tripmatch.com</a>
            </li>
          </ul>
        </div>
        ...
        <div className="card">
          ...
          <p>
            ...
            Match, you agree to this Policy.
          </p>
        </div>
        ...
        <div className="card">
          ...
          <ul>
            <li>
              Operate, maintain, and improve Trip Match features and
              performance.
            </li>
            <li>
        ...
        <div className="card">
          ...
          <p>
            Trip Match is not intended for children under 13. We do not
