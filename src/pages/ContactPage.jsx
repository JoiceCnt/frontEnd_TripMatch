// File: ContactUs.jsx
// Purpose: Super-minimal "Contact Us" box. No form, no backend.
// Behavior: Shows a message + a mailto link and a "Copy email" button.

import { useState } from "react";

export default function ContactUs() {
  const EMAIL = "support@tripmatch.com";
  ...
  *{box-sizing:border-box} body{background:var(--surface)}
  .wrap{min-height:100dvh; display:grid; place-items:start center; padding:48px 16px; font-family:"Gafata",system-ui,Segoe UI,Roboto,Arial,sans-serif; color:var(--text);}
  h1{margin:0 0 16px; font-size:40px; text-align:center; color:var(--title)}
  .card{width:100%; max-width:560px; padding:24px; border:1px solid var(--primary); border-radius:var(--radius); background:var(--field); box-shadow:var(--shadow);}
